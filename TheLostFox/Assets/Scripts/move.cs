...
public class move : MonoBehaviour
{
    ...
    void UpdateController()
    {
        ...
        if (!Mathf.Approximately(rb.linearVelocity.x, 0.0f))
        {
            look = new Vector2(rb.linearVelocity.x, 0);
            look.Normalize();
        }
    ...
    void UpdateAnimation()
    {
        ...
        anm.SetFloat("vx", rb.linearVelocity.x);
        anm.SetFloat("vy", rb.linearVelocity.y);
    }
